...
namespace Ciftlik_Proje
{
    class Tavuk: Hayvan
    {
        ...
        {
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\Administrator\Desktop\NDP Ders Notları\Hayvan Ciftligi Dosyalar\tavuk.wav");
            player.Play();
        }
    }
}